...
class FacebookCrawler:
    ...
    def facebook_login(self):
        ...
        self.driver.find_element_by_id("email").send_keys("bbqws@naver.com")
        self.driver.find_element_by_id("pass").clear()
        self.driver.find_element_by_id("pass").send_keys("ekffurl!23")
    ...
    def play_crawling(self):
        try:
            ...
            print('정상 종료 되었습니다.')
crawler = FacebookCrawler('', '2014-02', '2017-05', 5)
